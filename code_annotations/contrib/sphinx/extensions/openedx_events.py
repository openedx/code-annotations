...
def find_events(source_path: str) -> dict[str, dict[str, t.Any]]:
    """
    ...
    Returns:
        Found events indexed by event type.
    """
...
class OpenedxEvents(SphinxDirective):
    ...
    def iter_nodes(self) -> t.Iterator[nodes.section]:
        ...
        Yields:
            Node for each domain
        """
        events = find_events(self.env.config.openedxevents_source_path)

        current_domain = ""
        domain_header: nodes.section | None = None
        current_subject = ""
        subject_header: nodes.section | None = None
        ...
        for event_type in sorted(events):
            ...
            if subject != current_subject:
                ...
                assert domain_header is not None
...
def setup(app: t.Any) -> dict[str, t.Union[str, bool]]:
    """

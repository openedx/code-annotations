...
"""
code-annotations documentation build configuration file.
...
#
# html_title = 'code-annotations v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Extensible tools for parsing annotations in codebases',
     'Miscellaneous'),
]
